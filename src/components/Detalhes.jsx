...
const filmes = [
    ...
    { id: 7, tipo: 'serie', titulo: 'Ruptura', poster: 'https://image.tmdb.org/t/p/w500/3DjOAUBR8Hra4R9kK9U8jDaoqyC.jpg' },
    ...
    { id: 11, tipo: 'serie', titulo: 'Stranger Things', poster: 'https://www.quadrorama.com.br/wp-content/uploads/2025/11/5-6.png' },
    { id: 12, tipo: 'serie', titulo: 'Vikings', poster: 'https://cdn.iset.io/assets/55268/produtos/19779/1a71fca7bbc9b92a0ac9f834e7da7c8f65424a15369b6.png' },
    ...
    { id: 20, tipo: 'serie', titulo: 'Shogun', poster: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTqREON83FJbw-Wnbn9bLQ0sMJdmkJCFytb_K7CVQCFy8XuP9EMr-PSOu4&s=10' },
    { id: 21, tipo: 'serie', titulo: 'La Casa de Papel', poster: 'https://br.web.img3.acsta.net/r_1280_720/pictures/20/04/07/19/31/0195880.jpg' },
...
const Detalhes = () => {
    ...
    const item = filmes.find((f) => f.id === Number(id));
